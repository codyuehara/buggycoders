...
public:
	...
	speed = 0.0;
        ...
        */
        ...
        // TODO: create ROS subscribers and publishers
	brake_pub = n.advertise<ackermann_msgs::AckermannDriveStamped>("vesc/low_level/ackermann_cmd_mux/input/teleop", 100);
	brake_bool_pub = n.advertise<std_msgs::Bool>("brake_bool", 100);
	scan_sub = n.subscribe("scan", 10, &Safety::scan_callback, this);
	odom_sub = n.subscribe("vesc/odom", 10, &Safety::odom_callback, this);	
    }
