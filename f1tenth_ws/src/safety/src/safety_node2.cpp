...
public:
    Safety() {
        ...
        odom_sub = n.subscribe("vesc/odom", 1000, &Safety::odom_callback, this);
        drive_pub = n.advertise<ackermann_msgs::AckermannDriveStamped>("vesc/low_level/ackermann_cmd_mux/input/teleop", 10);
        brake_pub = n.advertise<std_msgs::Bool>("brake_bool", 10);
        /*
