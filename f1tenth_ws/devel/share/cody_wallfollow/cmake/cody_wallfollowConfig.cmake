...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cody_wallfollow' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/buggycoders/buggycoders/f1tenth_ws/src/f1tenth_system/racecar/cody_wallfollow/${idir}'.  ${_report}")
    endif()
