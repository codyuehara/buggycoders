...
if("TRUE" STREQUAL "TRUE")
  set(ackermann_cmd_mux_SOURCE_PREFIX /home/buggycoders/buggycoders/f1tenth_ws/src/f1tenth_system/racecar/ackermann_cmd_mux)
  set(ackermann_cmd_mux_DEVEL_PREFIX /home/buggycoders/buggycoders/f1tenth_ws/devel)
  ...
  set(ackermann_cmd_mux_INSTALL_PREFIX /home/buggycoders/buggycoders/f1tenth_ws/install)
...
if(NOT "/home/buggycoders/buggycoders/f1tenth_ws/devel/include;/home/buggycoders/buggycoders/f1tenth_ws/src/f1tenth_system/racecar/ackermann_cmd_mux/include " STREQUAL " ")
  set(ackermann_cmd_mux_INCLUDE_DIRS "")
  set(_include_dirs "/home/buggycoders/buggycoders/f1tenth_ws/devel/include;/home/buggycoders/buggycoders/f1tenth_ws/src/f1tenth_system/racecar/ackermann_cmd_mux/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ackermann_cmd_mux' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/buggycoders/buggycoders/f1tenth_ws/src/f1tenth_system/racecar/ackermann_cmd_mux/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT ackermann_cmd_mux_NUM_DUMMY_TARGETS)
      set(ackermann_cmd_mux_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ackermann_cmd_mux::wrapped-linker-option${ackermann_cmd_mux_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ackermann_cmd_mux_NUM_DUMMY_TARGETS "${ackermann_cmd_mux_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ackermann_cmd_mux::wrapped-linker-option${ackermann_cmd_mux_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ackermann_cmd_mux_LIBRARIES "${interface_target_name}")
