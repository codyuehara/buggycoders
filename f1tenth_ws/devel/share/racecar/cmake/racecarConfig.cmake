...
if("TRUE" STREQUAL "TRUE")
  set(racecar_SOURCE_PREFIX /home/buggycoders/buggycoders/f1tenth_ws/src/f1tenth_system/racecar/racecar)
  set(racecar_DEVEL_PREFIX /home/buggycoders/buggycoders/f1tenth_ws/devel)
  set(racecar_INSTALL_PREFIX "")
  set(racecar_PREFIX ${racecar_DEVEL_PREFIX})
else()
  set(racecar_SOURCE_PREFIX "")
  set(racecar_DEVEL_PREFIX "")
  set(racecar_INSTALL_PREFIX /home/buggycoders/buggycoders/f1tenth_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'racecar' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'racecar' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/buggycoders/buggycoders/f1tenth_ws/src/f1tenth_system/racecar/racecar/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT racecar_NUM_DUMMY_TARGETS)
      set(racecar_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::racecar::wrapped-linker-option${racecar_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR racecar_NUM_DUMMY_TARGETS "${racecar_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::racecar::wrapped-linker-option${racecar_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND racecar_LIBRARIES "${interface_target_name}")
...
set(depends "tf;tf2_ros;urg_node;joy;rosbag;rostopic;rviz;gmapping;hector_mapping;robot_pose_ekf")
