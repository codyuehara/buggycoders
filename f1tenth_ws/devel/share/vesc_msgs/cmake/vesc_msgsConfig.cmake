...
if("TRUE" STREQUAL "TRUE")
  set(vesc_msgs_SOURCE_PREFIX /home/buggycoders/buggycoders/f1tenth_ws/src/f1tenth_system/vesc/vesc_msgs)
  set(vesc_msgs_DEVEL_PREFIX /home/buggycoders/buggycoders/f1tenth_ws/devel)
  ...
  set(vesc_msgs_INSTALL_PREFIX /home/buggycoders/buggycoders/f1tenth_ws/install)
...
if(NOT "/home/buggycoders/buggycoders/f1tenth_ws/devel/include " STREQUAL " ")
  set(vesc_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/buggycoders/buggycoders/f1tenth_ws/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vesc_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/buggycoders/buggycoders/f1tenth_ws/src/f1tenth_system/vesc/vesc_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT vesc_msgs_NUM_DUMMY_TARGETS)
      set(vesc_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::vesc_msgs::wrapped-linker-option${vesc_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR vesc_msgs_NUM_DUMMY_TARGETS "${vesc_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::vesc_msgs::wrapped-linker-option${vesc_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND vesc_msgs_LIBRARIES "${interface_target_name}")
