...
if(NOT "/home/buggycoders/buggycoders/f1tenth_ws/src/f1tenth_system/vesc/vesc_driver/include " STREQUAL " ")
  set(vesc_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/buggycoders/buggycoders/f1tenth_ws/src/f1tenth_system/vesc/vesc_driver/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vesc_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/buggycoders/buggycoders/f1tenth_ws/src/f1tenth_system/vesc/vesc_driver/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT vesc_driver_NUM_DUMMY_TARGETS)
      set(vesc_driver_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::vesc_driver::wrapped-linker-option${vesc_driver_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR vesc_driver_NUM_DUMMY_TARGETS "${vesc_driver_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::vesc_driver::wrapped-linker-option${vesc_driver_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND vesc_driver_LIBRARIES "${interface_target_name}")
